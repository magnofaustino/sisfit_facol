        ...
        <div class="panel panel-primary filterable">
            <div class="panel-heading">
                ...
                <div class="pull-right">
                    <a href="cadastro_treino.php" class="btn btn-warning btn-sm" role="button">Incluir</a>
...
<td class="text-center"><a href="alterar_treino.php?tx=<?php echo $id?>" class='btn btn-info btn-xs'><span class="glyphicon glyphicon-edit"></span>Editar</a>
