...
<html>
	<head>
		<title>Relátorio do Contas a Receber</title>
		<meta charset="UTF-8"></meta>
	</head>
        <body>
            <div class="container">
            <div class="row">
                <form  action="relatorio_contas_receber.php"  method="GET">      
            <fieldset>
                <div class="panel panel-primary">
                <div class="panel-heading"><h4>Relátorio do Contas a Receber</h4></div>
